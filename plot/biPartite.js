!function(){
	var bP={};	
	var b=30, bb=600, height=600, buffMargin=1, minHeight=14;
	var c1=[-140, 40], c2=[80, 272], c3=[30, 300]; //Column positions of labels.
	var colors =["#3366CC", "#DC3912",  "#FF9900","#109618", "#990099", "#0099C6","#3366CC", "#DC3912",  "#FF9900","#109618"];
	...
	function drawPart(data, id, p){
		...
		mainbar.append("text").attr("class","barvalue")
			...
			.text(function(d,i){ return "$"+Math.round(d.value/1000)+"K" ;})
	...
	function drawHeader(header, id){
		d3.select("#"+id).append("g").attr("class","header").append("text").text(header[2])
			.style("font-size","20").attr("x",308).attr("y",-20).style("text-anchor","middle")
		...
		[0,1].forEach(function(d){
			...
			h.append("text").text("Total").attr("x", (c2[d]-30))
				.attr("y", -5).style("fill","grey");
	...
	function transitionPart(data, id, p){
		...
		mainbar.select(".barvalue").transition().duration(500)
			.attr("y",function(d){ return d.middle+5;}).text(function(d,i){ return "$"+Math.round(d.value/1000)+"K" ;});
